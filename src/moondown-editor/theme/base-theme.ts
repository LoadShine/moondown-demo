...
const createEditorTheme = (colors: typeof light) => EditorView.theme({
    "&": {
    ...
    // AI Ghost Writer
    ".cm-new-text": { animation: "colorChange 2s forwards" },
    ".cm-loading-widget": {
        display: "inline-flex",
        alignItems: "center",
        padding: "2px 5px",
...
}, {dark: false}); // This dark flag is for CodeMirror's internal logic, we handle colors manually.

// --- Syntax Highlighting Styles ---
const createHighlightStyle = (colors: typeof light) => HighlightStyle.define([
...
// --- Export Light Theme ---
export const editorLightTheme = createEditorTheme(light);
...
// --- Export Dark Theme ---
export const editorDarkTheme = createEditorTheme(dark);
